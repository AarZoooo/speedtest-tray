...
export async function handleHistoryToggleClick() {
  ...
  if (testView.classList.contains("view-active")) {
    ...
    historyView.classList.replace("view-active", "view-hidden");
    testView.classList.replace("view-hidden", "view-active");
    toggleBtn.innerHTML = HISTORY_ICON_HTML;
